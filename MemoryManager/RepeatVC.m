...
//  MemoryManager
//
//  Created by Cormac Quinn on 30/07/2012.
...
- (void)viewDidLoad
{
    ...
    self.data = [[NSArray alloc] initWithObjects:@"Never", @"Every Day", @"Every Week", @"Every Month", @"Every Year", nil];
